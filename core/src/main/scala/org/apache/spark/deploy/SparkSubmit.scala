...
object SparkSubmit extends CommandLineUtils {
  ...
  override def main(args: Array[String]): Unit = {
    val appArgs = new SparkSubmitArguments(args)  //拿到参数  --master yarn --deploy-mode cluster --class org.apache.spark.examples.SparkPi --executor-memory 500m --executor-cores 1 /opt/module/spark/examples/jars/spark-examples_2.11-2.2.0.jar 1000
    if (appArgs.verbose) {
      // scalastyle:off println
